...
class Attendance:
    ...
    def __init__(self,root):
        ...
        main_frame.place(x=75,y=95,width=1355,height=510)
        ...
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Database Details",font=("verdana",12,"bold"),fg="navyblue")
    ...
    #Update button
        upd_btn=Button(right_frame,command=self.update_data,text="Update",width=12,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update attendance set studentid=%s,std_roll_no=%s,std_name=%s,std_time=%s,std_date=%s,std_attendance=%s where studentid=%s",( 
                    self.var_id.get(),
                    self.var_roll.get(),
                    self.var_name.get(),
                    self.var_time.get(),
